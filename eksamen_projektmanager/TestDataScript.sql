...
-- tasks data
-- -----------------------------------------------------
INSERT INTO `projektello`.`tasks` (`taskid`, `projectid`, `subprojectid`, `taskname`, `timeestimate`, `deadline`, `taskstatus`) VALUES ('1', '1', '2', 'opgave 1', '20', '2021-02-02', 2);
INSERT INTO `projektello`.`tasks` (`taskid`, `projectid`, `subprojectid`, `taskname`, `timeestimate`, `deadline`, `taskstatus`) VALUES ('2', '1', '1', 'opgave 2', '5', '2021-02-02', 2);
INSERT INTO `projektello`.`tasks` (`taskid`, `projectid`, `subprojectid`, `taskname`, `timeestimate`, `deadline`, `taskstatus`) VALUES ('3', '1', '3', 'opgave 3', '12', '2021-02-02', 1);
INSERT INTO `projektello`.`tasks` (`taskid`, `projectid`, `subprojectid`, `taskname`, `timeestimate`, `deadline`, `taskstatus`) VALUES ('4', '1', '1', 'opgave 4', '2', '2021-02-02', 0);
INSERT INTO `projektello`.`tasks` (`taskid`, `projectid`, `subprojectid`, `taskname`, `timeestimate`, `deadline`, `taskstatus`) VALUES ('5', '1', '1', 'opgave 5', '25', '2021-02-02', 1);
INSERT INTO `projektello`.`tasks` (`taskid`, `projectid`, `subprojectid`, `taskname`, `timeestimate`, `deadline`, `taskstatus`) VALUES ('6', '2', '4', 'opgave 1', '30', '2021-09-05', 0);
